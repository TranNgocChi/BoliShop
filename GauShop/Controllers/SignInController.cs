...
namespace GauShop.Controllers
{
    public class SignInController : Controller
    {
        ...
        public SignInController(SignInManager<User> signInManager, IDistributedCache sessionCache,
            SessionHelper sessionHelper, ILogger<SignInController> logger)
        {
        ...
        {
            _logger.LogInformation("ExternalLoginCallback started");
            if (remoteError != null)
            {
            ...
            _logger.LogInformation($"Name {nameUser}");
            string sessionId = "";
            byte[] sessionData = null;
            DistributedCacheEntryOptions sessionOptions = new();
